...
- **Community** refers ro: all member(s), contributor(s), and maintainer(s) of ***"asdf-openssl plugin"***

- **Device** means any device that can access the Service such as a computer, a cellphone or a digital tablet.

- **Service** refers to the Website and/or project ***"asdf-openssl plugin"***
...
- **Website** refers to "Maintainer(s)", accessible from [https://VadimDor.github.io/asdf-openssl](https://VadimDor.github.io/asdf-openssl)
