...
<tr>
    <td align="center">
        <a href="https://github.com/sample">
            <img src="/assets/profile.png" width="80;" alt="sample"/>
            <br />
            <sub><b>sample</b></sub>
        </a>
    </td>
...
<tr>
    <td align="center">
        <a href="https://github.com/VadimDor">
            <img src="/assets/profile.png" width="80;" alt="VadimDor"/>
            <br />
...
[![Recent Star Gazers](https://reporoster.com/stars/dark/VadimDor/<TOOL NAME LC>)](https://github.com/VadimDor/asdf-openssl/stargazers)

[![Recent Forkers](https://reporoster.com/forks/dark/VadimDor/<TOOL NAME LC>)](https://github.com/VadimDor/asdf-openssl/network/members)

---

## Dependencies

This project definitely wouldn't have been quite so possible without the making use of the following package and components. Full credit and big kudos to their respective authors, who've done an amazing job in building and maintaining them. For a full breakdown of dependency licenses, please see [ACKNOWLEDGMENTS](https://github.com/VadimDor/asdf-openssl/blob/main/ACKNOWLEDGMENTS.md)
...
Would you like to be listed here? Whatever your skill set, asdf-openssl plugin needs people like you to help support future development. Check out the [Contributing Page](/contributing.md) for ways that you can get involved. Huge thank you to everyone who has already contributed! 💖
