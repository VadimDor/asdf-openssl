...
setup_test() {
  ...
  ASDF_ASDF-OPENSSL_TEST_TEMP="$(mktemp -t asdf-openssl-utils-tests.XXXX -d)"
  ...
  ASDF_INSTALL_PATH="${ASDF_DATA_DIR}/installs/asdf-openssl/1.6.0"
  export ASDF_INSTALL_PATH
  ASDF_DOWNLOAD_PATH="${ASDF_DATA_DIR}/downloads/asdf-openssl/1.6.0"
  export ASDF_DOWNLOAD_PATH
  ASDF_ASDF-OPENSSL_MOCK_GCC_DEFINES="#"
  export ASDF_ASDF-OPENSSL_MOCK_GCC_DEFINES

  # Mock some other vars
  export XDG_CONFIG_HOME
  XDG_CONFIG_HOME="$ASDF_ASDF-OPENSSL_TEST_TEMP"
  ...
  ln -s "$PROJECT_DIR" "${ASDF_DATA_DIR}/plugins/asdf-openssl"
}
